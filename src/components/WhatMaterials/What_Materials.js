		...
		<>
			<Container fluid className='Materials_container' style={{ margin: '0px auto 150px', maxWidth: '1600px', }}>
				<Row>
					...
					<CardGroup>
						<Card className='Materials_card' style={{ backgroundColor: '#e5e5e5', border: 'none', flexWrap: 'wrap', alignContent: 'flex-start', }}>
						...
						<Card className='Materials_card' style={{ backgroundColor: '#e5e5e5', border: 'none', flexWrap: 'wrap', alignContent: 'flex-end', }}>
