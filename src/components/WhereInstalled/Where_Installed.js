...
function Where_Installed() {
	...
	return (
		<>
			<Container style={{ margin: '150px auto 150px', maxWidth: '1600px', }}>
				<Row style={{}}>
					<h2 className='Where_Installed_title' style={{ fontSize: '42px', textAlign: 'center', }}>Куда устанавливаются мягкие окна</h2>
					<Col style={{ marginTop: '40px', display: 'flex', position: 'relative', }}>
						<Box className='Where_Installed_box' sx={{ flexGrow: 1, display: 'flex', marginRight: 'auto', maxWidth: '194px', }}>
						...
						<Image fluid src={Rectangle} alt="Rectangle!" className='Where_Installed_img' style={{}} />
						<Col className='Where_Installed_block_button' style={{ maxWidth: '756px', padding: '40px 30px', top: '32%', left: '24%', position: 'absolute', backgroundColor: '#e5e5e5', }}>
