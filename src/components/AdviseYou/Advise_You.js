		...
		<>
			<Container className='advise_container' style={{ width: '100%', maxWidth: '100%', margin: '100px auto 150px', }}>
				<Row>
					...
					<Col className='advise_section' style={{ maxWidth: '1600px', margin: 'auto', display: 'flex', justifyContent: 'space-around', marginTop: '-654px', }}>
						<Col className="" style={{ marginLeft: '1rem', maxWidth: '512px', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'column', }}>
