...
function Advise_You() {
	return (
		<>
			<Container className='advise_container' style={{ width: '100%', maxWidth: '1600px', margin: '100px auto 150px', }}>
				<Row>
					<Image src={Rectangle} alt='Rectangle!' className='advise_imgRectangle' style={{ height: '661px', }} />
					<Col className='advise_section' style={{ margin: 'auto', display: 'flex', justifyContent: 'space-between', marginTop: '-654px', }}>
