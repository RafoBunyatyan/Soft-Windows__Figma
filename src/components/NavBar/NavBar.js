		...
		<>
			<Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" style={{ zIndex: "1", }}>
				<Container>
					...
					<Button className="myButton" style={{ padding: "14px 24px", border: "1px solid #21b34a", color: "#21b24a", backgroundColor: "#363636", display: "flex", alignItems: "center", justifyContent: "center", }}>
