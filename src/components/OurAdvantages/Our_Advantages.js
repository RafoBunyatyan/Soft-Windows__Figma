		...
		<>
			<Container fluid className='' style={{ margin: '110px auto', padding: '0', }}>
				<Row className='' style={{ maxWidth: '1352px', margin: '0 auto', }}>
					<h2 className='article_ourTitle' style={{ fontSize: '42px', color: '#463B3B', display: 'flex', color: 'rgb(70, 59, 59)', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', marginBottom: '3.1rem', }}>
						Наши преимущества
					</h2>
					<Col lg={12} className='' style={{ display: 'flex', flexWrap: 'wrap', padding: '0', justifyContent: 'center', }}>
						<Col md={4} className='article_container'>
							...
							<p className='article_our'>Срок службы составляет 10 лет, при соблюдении правил эксплуатации.</p>
						</Col>
						<Col md={4} className='article_container'>
							...
							<p className='article_our'>Мы проведём инструктаж по установке, если хотите выполнить монтаж самостоятельно.</p>
						</Col>
						<Col md={4} className='article_container'>
							...
							<p className='article_our'>Мы работаем 24/7, поэтому ваш заказ будет выполнен и смонтирован в кратчайшие сроки!</p>
						</Col>
					</Col>
					<Col lg={12} className='' style={{ display: 'flex', flexWrap: 'wrap', padding: '0', justifyContent: 'center', }}>
						<Col md={4} className='article_container'>
							...
							<p className='article_our'>Мы не экономим на ваших окнах и используем только лучшие всепогодные пленки!</p>
						</Col>
						<Col md={4} className='article_container'>
							...
							<p className='article_our'>Немецкая ткань ПВХ в десяти расцветках («Стандарт»). С нами надёжно и практично!</p>
						</Col>
						<Col md={4} className='article_container'>
							...
							<p className='article_our'>Мы используем только прочнейшие москитные сетки, выдерживающие очень большие нагрузки.</p>
						</Col>
					</Col>
				</Row>
			</Container>
